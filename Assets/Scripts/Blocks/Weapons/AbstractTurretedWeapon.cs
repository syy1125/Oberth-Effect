...
{
public abstract class AbstractTurretedWeapon : MonoBehaviour, IResourceConsumerBlock, IWeaponSystem
{
	[Header("References")]
	...
	public abstract IReadOnlyDictionary<DamageType, float> GetMaxFirepower();
